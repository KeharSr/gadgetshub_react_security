...
const Products = ({ productInformation }) => {
  const initialFavoriteStatus =
    JSON.parse(localStorage.getItem(`favorite_${productInformation._id}`)) ||
    false;
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="relative aspect-square rounded-2xl bg-[#282D39] p-4 flex items-center justify-center">
            <img
              ...
              className="w-4/5 h-4/5 object-fit transition-transform duration-300 group-hover:scale-110 "
